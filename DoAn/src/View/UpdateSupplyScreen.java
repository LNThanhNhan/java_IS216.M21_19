 ...
 * @author MyPC
 */
public class UpdateSupplyScreen extends javax.swing.JDialog {

    /**
     * Creates new form AddSupplyScreen
     */
    EmployeeScreen  emp = new EmployeeScreen();
    public UpdateSupplyScreen(java.awt.Frame parent, boolean modal, Supply supply) {
        super(parent, modal);
        initComponents();
    ...
    public void setView(Supply supply) {
        
        // set data
        IdsupTextField.setText(String.valueOf(supply.getIdsup()));
        IdperTextField.setText(String.valueOf(supply.getIdper()));       
        StatusTextField.setText(SupplyStatus(supply.getStatus()));      
        DetailTextArea.setText(supply.getDetail());
        NeedFoodCheckBox.setSelected(getValueCheckBoxBoolean(supply.getNeedfood()));
        NeedNecessCheckBox.setSelected(getValueCheckBoxBoolean(supply.getNeednecess()));
        NeedEquipCheckBox.setSelected(getValueCheckBoxBoolean(supply.getNeedequip()));
    ...
    private void initComponents() {
        ...
        ErrorLabel.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addComponent(NeedFoodCheckBox, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(177, 177, 177)
                .addComponent(NeedNecessCheckBox, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 167, Short.MAX_VALUE)
                .addComponent(NeedEquipCheckBox, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(58, 58, 58))
        );
    ...
    private void IdperTextFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IdperTextFieldKeyPressed
        // TODO add your handling code here:
        ErrorLabel.setText("");
        LimitChar(IdperTextField, evt, 10);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSupplyScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
