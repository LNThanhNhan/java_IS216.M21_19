 ...
 */
public class DoctorScreenDeadLock extends javax.swing.JFrame {
...
//                    setAdvisoryTableSize();
    ...
    public DoctorScreenDeadLock() {
        adcon = new AdvisoryController();
        int id=Integer.parseInt(JOptionPane.showInputDialog("Nhập id bác sĩ"));
        doctor=new Doctor(id,"user10","Trần Văn B",0,"0937976863",1,2,"Bệnh viện K","Hà Nội");
    ...
    private void initComponents() {
        ...
        DL1.setText("Chấp nhận yêu cầu 1 và 2");
        ...
        DL2.setText("Chấp nhận yêu cầu 2 và 1");
    ...
    private void TopPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TopPanelMouseClicked
        ...
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            if (DoctorScreenDeadLock.this.getExtendedState() == MAXIMIZED_BOTH) {
                DoctorScreenDeadLock.this.setExtendedState(JFrame.NORMAL);
            } else {
                DoctorScreenDeadLock.this.setExtendedState(MAXIMIZED_BOTH);
            }
        }
    ...
    private void MinimizeButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MinimizeButtonMousePressed
        // TODO add your handling code here:
        DoctorScreenDeadLock.this.setState(Frame.ICONIFIED);
...
//        cps.setVisible(true);
    ...
    private void DL1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DL1ActionPerformed
        ...
        new SwingWorker() {
            ...
            protected Object doInBackground() throws Exception {
                if (AdvisoryList.size() >= 2) {
                    HashMap first = AdvisoryList.get(0);
                    HashMap second = AdvisoryList.get(1);
                    String id1 = (String) first.get("idad");
                    String id2 = (String) second.get("idad");
                    System.out.println("1");
                    int rs=adcon.AcceptDLAdvisory(Integer.toString(doctor.getIddoc()), id1, id2);
                    if(rs==1)
                    {
                        refreshForSearchScreen();
                        //JOptionPane.showMessageDialog(null, "Nhận thành công");
    ...
    private void DL2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DL2ActionPerformed
        ...
        new SwingWorker() {
            ...
            protected Object doInBackground() throws Exception {
                if (AdvisoryList.size() >= 2) {
                    HashMap first = AdvisoryList.get(1);
                    HashMap second = AdvisoryList.get(0);
                    String id1 = (String) first.get("idad");
                    String id2 = (String) second.get("idad");
                    System.out.println("1");
                    int rs=adcon.AcceptDLAdvisory(Integer.toString(doctor.getIddoc()), id1, id2);
    ...
    public void CheckOSType() {
        DoctorScreenDeadLock.this.getRootPane().setBorder(new LineBorder(new Color(76, 41, 211)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorScreenDeadLock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorScreenDeadLock().setVisible(true);
            }
        });
    }
